<div class="header">
    ...
    <div class="header_section">
        <div class="header_item headerButton"><a href="/test/register.php" class="a_index">Регистрация</a></div>
        <div class="header_item headerButton"><a href="/test/login.php" class="a_index">Вход</a></div>
    </div>
</div>